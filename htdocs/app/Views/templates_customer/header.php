          ...
          <li class="nav-item border-dashed">
            <a href="<?= base_url('products?type=' . $category['kode_type']) ?>" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
              <?php if (!empty($category['img'])): ?>
                <i class="<?= $category['img'] ?>" style="width: 24px; height: 24px;"></i>
              <?php else: ?>
            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                  ...
                  <li><a href="<?= base_url('products') ?>" class="dropdown-item">Shop</a></li>
                  <li><a href="<?= base_url('cart') ?>" class="dropdown-item">Cart</a></li>
