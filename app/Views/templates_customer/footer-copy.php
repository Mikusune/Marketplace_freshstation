                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <img src="<?php echo base_url() ?>assets/assets_shop/img/logo.png" alt="JSOFT" width="150" height="auto">
                                <p>Jual Beli Mobil Second Bekasi adalah platform jual beli mobil second terpercaya yang menawarkan pengalaman transaksi mudah, aman, dan transparan. Kami menyediakan berbagai pilihan mobil berkualitas, proses jual beli yang cepat, serta layanan pelanggan profesional. Temukan mobil impian atau jual mobil Anda dengan mudah hanya di Jual Beli Mobil Second Bekasi! 🚗</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i>Kota Bekasi, Jawa Barat , Indonesia</li>
                                    <li><i class="fa fa-pse"></i> +62 895 3080 7615</li>
                                    <li><i class="fa fa-envelope"></i> layanan@jualbelimobilsecond.com</li>
                                </ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Design by <a href="" target="_blank">kelompok 3</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <div class="scroll-top">
        <img src="<?php echo base_url() ?>assets/assets_shop/img/scroll-top.gif" alt="JSOFT">
    </div>
    <!--== Scroll Top Area End ==-->
    ...
    <script src="<?php echo base_url() ?>assets/assets_shop/js/header.js"></script>
